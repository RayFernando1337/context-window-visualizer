...
**Files Affected (27 files, 40+ occurrences):**
- components/ui/context-menu.tsx
- components/ui/input.tsx
- components/ui/textarea.tsx
- components/ui/select.tsx
- components/ui/checkbox.tsx
- components/ui/toast.tsx (3 occurrences)
- components/ui/toggle.tsx
- components/ui/button.tsx (2 occurrences)
- components/ui/sidebar.tsx (3 occurrences)
- components/ui/badge.tsx
- components/ui/dialog.tsx (2 occurrences)
- components/ui/menubar.tsx
- components/ui/command.tsx
- components/ui/radio-group.tsx
- components/ui/breadcrumb.tsx (2 occurrences)
- components/ui/calendar.tsx
- components/ui/switch.tsx (2 occurrences)
- components/ui/alert.tsx (2 occurrences)
- components/ui/drawer.tsx
- components/ui/navigation-menu.tsx
- components/ui/sonner.tsx
- components/ui/sheet.tsx (3 occurrences)
- components/ui/chart.tsx (2 occurrences)
- components/ui/input-otp.tsx
- components/ui/slider.tsx
- components/ui/tabs.tsx (2 occurrences)
...
1. **Identify All Occurrences**
   ...
   # Expected: Should list all 40+ occurrences across 27 files
   ```
...
3. **Verification Steps - MUST PASS:**
   ...
   bun run dev
   # Test focus states on buttons, inputs, and interactive elements
   # Expected: Focus rings should appear with proper offset
   
   # Build test
   bun run build
   # Expected: Should build without warnings about unknown utilities
   ```
...
1. **Check Current Usage**
   ...
   # Expected: Should show 4 files with hover:opacity patterns
   ```
...
- All hover opacity patterns work correctly
...
### Task 5.1: Test All shadcn/ui Components

**Objective:** Ensure all 50+ shadcn/ui components render and function correctly with v4.

**Component Categories:**
- **Form Components:** Button, Input, Textarea, Select, Checkbox, Radio Group, Switch
- **Layout Components:** Card, Separator, Aspect Ratio, Resizable  
...
- **Feedback Components:** Alert, Toast, Sonner, Progress, Skeleton
- **Data Display:** Table, Badge, Avatar, Calendar, Chart
- **Other:** Accordion, Collapsible, Command, Carousel, Sidebar
...
**Next Phase:** Phase 2 - File Cleanup  
